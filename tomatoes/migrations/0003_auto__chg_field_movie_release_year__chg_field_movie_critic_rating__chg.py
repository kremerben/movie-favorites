...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tomatoes_movie', 'release_year', self.gf('django.db.models.fields.SmallIntegerField')())
        ...
        db.alter_column(u'tomatoes_movie', 'runtime', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Movie.runtime'
        db.alter_column(u'tomatoes_movie', 'runtime', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        u'tomatoes.movie': {
            ...
            'release_year': ('django.db.models.fields.SmallIntegerField', [], {}),
