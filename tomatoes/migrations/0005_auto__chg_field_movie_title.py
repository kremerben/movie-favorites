...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field favorite on 'Movie'
        m2m_table_name = db.shorten_name(u'tomatoes_movie_favorite')
        ...
        db.alter_column(u'tomatoes_movie', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):
        # Removing M2M table for field favorite on 'Movie'
        db.delete_table(db.shorten_name(u'tomatoes_movie_favorite'))
    ...
    models = {
        ...
        u'tomatoes.movie': {
            ...
            'favorite': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'favorite'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
