...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tomatoes_movie', (
            ...
            ('mpaa_rating', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('runtime', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('audience_score', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
